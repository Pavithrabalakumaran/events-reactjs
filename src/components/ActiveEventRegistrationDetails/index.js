...
const ActiveEventRegistrationDetails = props => {
  const {activeEventRegistrationDetailsCase} = props

  const renderNoActiveEventView = () => (
    <p className="no-event-container">
  ...
  const renderRegisteredView = () => (
    <div className="view-container">
      ...
      />
      <p className="reg-des">you have already registered for the event</p>
    </div>
  )
  ...
  const renderActiveRegistrationDetails = () => {
    switch (activeEventRegistrationDetailsCase) {
